...
export class CoinGeckoAPI {
  ...
  async fetchTop100Coins(): Promise<Coin[]> {
    ...
    const url = `https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=250&page=1&sparkline=false&price_change_percentage=1h,24h,7d&x_cg_demo_api_key=${apiKey}`;
