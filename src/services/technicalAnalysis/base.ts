import type { PriceDataPoint, Trendline, EntryPoint } from '../coingeckoApi'

/**
 * Base technical analysis utilities and core indicators
 */
export class BaseTechnicalAnalysis {
  /**
